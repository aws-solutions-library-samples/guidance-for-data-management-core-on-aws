...
import { CustomDatasetInput, DATA_LINEAGE_DIRECT_SPOKE_INGESTION_REQUEST_EVENT, DATA_LINEAGE_SPOKE_EVENT_SOURCE, EventBridgeEventBuilder, EventPublisher, OpenLineageBuilder, RunEvent } from "@dm/events";
...
export class DataQualityProfileJobTask {
    ...
    public async process(event: DataAssetTask): Promise<any> {
        ...
        const rulesetName = `dm-createDataQualityProfile-${id}`;

        const qualityRulesetCommandPayload = {
            Name: rulesetName,
            Ruleset: event.dataAsset.workflow.dataQuality.ruleset,
            Description: 'Data quality ruleset generated by Data Management.',
        }
