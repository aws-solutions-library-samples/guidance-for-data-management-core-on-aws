...
import {
	accessLogBucketNameParameter,
	isolatedSubnetIdListParameter,
	privateSubnetIdListParameter,
	publicSubnetIdListParameter,
	vpcIdParameter,
} from '../shared/network.construct.js';
...
export class DataLineageStack extends Stack {
	constructor(scope: Construct, id: string, props: DataLineageStackProperties) {
		...
		new StringParameter(this, 'rdsClusterId', {
			parameterName: rdsClusterId,
			stringValue: aurora.rdsClusterId,
		});
